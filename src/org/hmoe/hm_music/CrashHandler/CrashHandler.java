package org.hmoe.hm_music.CrashHandler;
...
public class CrashHandler implements UncaughtExceptionHandler {  
    ...
    private String saveCrashInfoToFile(Throwable ex) {  
        ...
        try {  
            ...
            mDeviceCrashInfo.storeToXML(trace, "");  
            trace.flush();  
            trace.close();  
            return fileName;  
        } catch (Exception e) {  
    ...
    private void postReport(File file)  {  
        ...
        // 教程来提交错误报告  
    	String uriAPI="http://music2.hmacg.cn/android/bugpost.php";
		...
		try {
			...
			in.close();
			params.add(new BasicNameValuePair("error",new String(b, "UTF-8")));
		}catch (Throwable e) {
			e.printStackTrace();
		}  
